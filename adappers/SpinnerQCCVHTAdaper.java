...
public class SpinnerQCCVHTAdaper extends ArrayAdapter<QuyCheVCHT> {
    public SpinnerQCCVHTAdaper(@NonNull Context context, int resource, @NonNull List<QuyCheVCHT> objects) {
...
//        ImageView imageViewFlag = convertView.findViewById(R.id.image_view_flag);
        ...
        QuyCheVCHT st = getItem(position);

        if (st != null) {
            textViewName.setText(st.get_mucQuyChe());
            if(position==0 && idR==2){
